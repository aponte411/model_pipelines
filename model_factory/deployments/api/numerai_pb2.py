...
_RESPONSE_STATUSCODE = _descriptor.EnumDescriptor(
    ...
    file=DESCRIPTOR,
    values=[
        _descriptor.EnumValueDescriptor(name='started',
                                        index=0,
                                        number=0,
                                        serialized_options=None,
                                        type=None),
        _descriptor.EnumValueDescriptor(name='success',
                                        ...
                                        serialized_options=None,
                                        type=None),
        _descriptor.EnumValueDescriptor(name='failed',
                                        index=2,
                                        number=2,
                                        serialized_options=None,
                                        type=None),
        _descriptor.EnumValueDescriptor(name='not_found',
                                        index=3,
                                        number=3,
                                        serialized_options=None,
                                        type=None),
...
_TRAINREQUEST = _descriptor.Descriptor(
    ...
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(name='config',
                                    full_name='TrainRequest.config',
                                    index=0,
                                    number=1,
                                    type=9,
                                    cpp_type=9,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='competition',
                                    full_name='TrainRequest.competition',
                                    index=1,
                                    number=2,
                                    type=9,
                                    cpp_type=9,
...
_INFERENCEREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(name='config',
                                    full_name='InferenceRequest.config',
                                    index=0,
                                    number=1,
                                    type=9,
                                    cpp_type=9,
                                    ...
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='competition',
                                    full_name='InferenceRequest.competition',
                                    index=1,
                                    number=2,
                                    type=9,
                                    cpp_type=9,
                                    ...
                                    serialized_options=None,
                                    file=DESCRIPTOR),
        _descriptor.FieldDescriptor(name='submit',
                                    full_name='InferenceRequest.submit',
                                    index=2,
                                    number=3,
                                    type=8,
                                    cpp_type=7,
...
_PREDICTIONS = _descriptor.Descriptor(
    ...
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(name='predictions',
